...
HAMMING_7_4_DATA_BITS_COUNT:int = 4
HAMMING_7_4_ERRDETCT_BITS_COUNT:int  = 3
HAMMING_7_4_WORD_TO_SEND_BITS_COUNT:int  = 7

ENCODING_ERROR_DETECTION_BITS_POSITIONS_7_4:dict[str,int] = {
...
ENCODING_ERROR_DETECTION_BITS_CALC_7_4: dict[str, list[int]] = {
